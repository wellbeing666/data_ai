...
packages:
  ...
  '@oai/artifact-tool@file:local-deps/-oai-artifact-tool-oai-artifact_tool-2.8.0.tgz':
    resolution: {integrity: sha512-99oS0vN61LsO+PslshD4OhYLtPg3ajWxZDWDDjQ88/e1WLCIH84aWdxglftEGP8OmT8+TabCN9I6Xcb1cGKCUA==, tarball: file:local-deps/-oai-artifact-tool-oai-artifact_tool-2.8.0.tgz}
    version: 2.8.0
    bundledDependencies:
      - '@oai/walnut'
      - skia-canvas
